...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'user.update': {
    roles: ['system-administrator', 'hr-manager'],
...
const tenantRoles: string[] = ['system-administrator', 'employee', 'team-lead', 'hr-manager'];
